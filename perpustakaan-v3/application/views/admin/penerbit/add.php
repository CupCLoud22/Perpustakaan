  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Data Penerbit</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
                <?php echo form_open('admin/penerbit/add', array('class' => 'form-horizontal')); ?>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Penerbit</label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" name="nama" placeholder="Nama penerbit" value="<?php echo set_value('nama') ?>">

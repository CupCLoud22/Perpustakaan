  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
                <?php echo form_open('admin/menu/edit/'.$b->menu_id, array('class' => 'form-horizontal')); ?>
                  <input type="hidden" name="id" value="<?php echo $b->menu_id ?>">
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Nama Menu</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="menu" placeholder="Nama Menu" value="<?php echo $b->menu_name ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="url" placeholder="URL" value="<?php echo $b->menu_url ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" name="icon" placeholder="Icon" value="<?php echo $b->menu_icon ?>">

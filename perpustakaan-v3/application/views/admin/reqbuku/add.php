  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Data Request Buku</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Tambah Data Request Buku</h3>
        </div>
        <div class="box-body">
                <?php echo form_open('admin/reqbuku/add', array('class' => 'form-horizontal')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" name="pengarang" placeholder="Pengarang" value="<?php echo set_value('pengarang') ?>">

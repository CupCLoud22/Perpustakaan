  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Laporan Buku Masuk</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border no-print">
          <h3 class="box-title">Laporan Buku Masuk</h3>
        </div>
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <?php echo form_open('admin/laporan/c_bmasuk', array('class' => 'form-horizontal', 'method' => 'get', 'target' => '_blank')) ?>
            ...
            <div class="col-md-6">
               ...
               <?php echo form_open('admin/laporan/ex_bmasuk', array('class' => 'form-horizontal', 'method' => 'get')) ?>
                <div class="form-group">
                  <label class="col-sm-4 control-label">Dari Tanggal</label>
                   <div class="col-sm-8">
                            <div class='input-group date datepicker'>

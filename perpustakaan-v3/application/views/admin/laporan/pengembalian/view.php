  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Laporan Pengembalian Buku</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Laporan Pengembalian Buku</h3>
        </div>
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <?php echo form_open('admin/laporan/c_pengembalian', array('class' => 'form-horizontal', 'method' => 'get', 'target' => '_blank')) ?>
